...
# Label Encoder and One Hot Encoder. These two encoders are parts of the SciKit Learn library in Python,
# and they are used to convert categorical data, or text data, into numbers
import numpy as np
import pandas as pd
from config import TRAIN_PATH, TEST_PATH, PROCESSED_TRAIN_PATH, PROCESSED_TEST_PATH

# to split the path name into a pair root and ext. Here, ext stands for extension and 
# has the extension portion of the specified path while root is everything except ext part.
